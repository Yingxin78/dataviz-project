...
# Visulize 3: Alcohol Consumption in different Schools
```{r}
...
```
## Gabriel Pereira (GP) has more students with little alcohol consumption


# Visulize 4: Alcohol Consumption Satistics with different Family Relationship 
```{r}
...
```
## Quality of family relationships (numeric: from 1 - very bad to 5 - excellent) is slightly relavent to alcohol consumption. The better relatiobship, the less alcolhol comsumption.
